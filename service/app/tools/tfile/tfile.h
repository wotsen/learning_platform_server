/*
 * @Date: 2019-08-11 12:40:21
 * @LastEditors: 余王亮
 * @LastEditTime: 2019-08-11 14:35:54
 */
#ifndef __TFILE_H__
#define __TFILE_H__
...
template <> const char* newlineString<Newline::atari8>();
template <> const char* newlineString<Newline::cr>();
template <> const char* newlineString<Newline::cr_lf>();
template <> const char* newlineString<Newline::lf>();
template <> const char* newlineString<Newline::lf_cr>();
template <> const char* newlineString<Newline::nl>();
template <> const char* newlineString<Newline::rs>();
template <> const char* newlineString<Newline::zx8x>();

template <> const char* modeString<Mode::read>();
template <> const char* modeString<Mode::readWrite>();
template <> const char* modeString<Mode::write>();
template <> const char* modeString<Mode::truncate>();
template <> const char* modeString<Mode::append>();
template <> const char* modeString<Mode::readAppend>();
