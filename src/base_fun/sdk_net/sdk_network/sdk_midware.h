...
// sdk中间件处理
using sdk_midware = bool (*)(struct sdk_net_interface &interface, const insider::sdk::Sdk &sdk_req, insider::sdk::Sdk &sdk_res);
...
#define SDK_IMPORT_MIDWARE(midware, enable) extern bool midware(struct sdk_net_interface &interface, const insider::sdk::Sdk &sdk_req, insider::sdk::Sdk &sdk_res);\
